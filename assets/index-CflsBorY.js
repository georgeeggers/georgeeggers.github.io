...
}`,t},h=e=>`background-color: ${f(e.v,3,e.saturation)} border: 1px solid ${f(e.v,4,e.saturation)}`,g=e=>`background-color: ${f(e.v,2,e.saturation)} color: ${f(e.v,7,e.saturation)} border: 1px solid ${f(e.v,5,e.saturation)}`,_=()=>{G(n).length=0;let e=$(180)+135,t=e-$(45)-20,a=$(55)+25,o=($(30)+350)%360,s=$(40)+60;F(n,[{name:`main`,v:e,saturation:s,id:Aa()},{name:`secondary`,v:t,saturation:s,id:Aa()},{name:`warn`,v:a,saturation:s,id:Aa()},{name:`fail`,v:o,saturation:s,id:Aa()}],!0);let c=$(20);F(r,{v:e,saturation:c,id:Aa()},!0),F(i,{v:e,saturation:c,id:Aa()},!0)};var v=Ra(),y=L(v),b=I(y),x=I(b),ee=I(x);ba(I(ee),{size:`30`}),O(ee),ke(2),O(x);var te=R(x,4);Y(te,17,()=>G(n),Ir,(e,t,n)=>{var r=ja(),i=I(r),a=I(i);Ei(a);var o=R(a,2),s=I(o);O(o);var c=R(o,2);Ei(c);var l=R(c,2),u=I(l);O(l);var d=R(l,2);Ei(d),O(i),O(r),z(e=>{J(s,`${G(t).v??``}deg`),X(c,`accent-color: hsl(${G(t).v??``}, 100%, 50%);`),J(u,`${G(t).saturation??``}% saturation`),X(d,`accent-color: ${e??``}`)},[()=>f(G(t).v,50,G(t).saturation)]),Ni(a,()=>G(t).name,e=>G(t).name=e),Ni(c,()=>G(t).v,e=>G(t).v=e),Ni(d,()=>G(t).saturation,e=>G(t).saturation=e),q(e,r)});var ne=R(te,2);ne.__click=()=>G(n).push({name:`new_color`,v:0,saturation:100,id:Aa()}),wa(I(ne),{size:`20`}),ke(),O(ne);var re=R(ne,4),ie=I(re),ae=R(I(ie),2);Da(I(ae),{get value(){return G(p)},set value(e){F(p,e,!0)}}),O(ae),O(ie),O(re);var oe=R(re,2),S=I(oe),se=I(S),ce=I(se);O(se);var le=R(se,2);Ei(le);var ue=R(le,2),de=I(ue);O(ue);var fe=R(ue,2);Ei(fe),O(S),O(oe);var pe=R(oe,4),me=I(pe),he=I(me),ge=I(he);O(he);var _e=R(he,2);Ei(_e);var ve=R(_e,2),ye=I(ve);O(ve);var be=R(ve,2);Ei(be),O(me),O(pe);var xe=R(pe,2);xe.__click=c;var Se=I(xe);Ca(I(Se),{size:`20`}),O(Se),ke(),O(xe);var Ce=R(xe,2);Ce.__click=o;var we=I(Ce);ga(I(we),{size:`20`}),O(we),ke(),O(Ce);var C=R(Ce,2);C.__click=_,Ta(I(C),{size:`20`}),ke(),O(C),O(b);var Te=R(b,2),Ee=R(I(Te),2);Y(Ee,17,()=>G(n),Ir,(e,t)=>{var n=Na();Y(n,20,()=>({length:10}),Ir,(e,n,r)=>{var i=Ma(),a=L(i),o=R(a,2);o.__click=()=>s(f(G(t).v,r,G(t).saturation)),z((e,t,n)=>{Z(a,`for`,e),X(a,`grid-area: c${r}; background-color: ${t??``};`),Z(o,`id`,n)},[()=>f(G(t).v,r,G(t).saturation),()=>f(G(t).v,r,G(t).saturation),()=>f(G(t).v,r,G(t).saturation)]),q(e,i)}),O(n),q(e,n)});var De=R(Ee,2),w=R(I(De),2);Y(w,21,()=>G(n),Ir,(e,t)=>{var n=Pa(),r=I(n,!0);O(n),z(e=>{X(n,e),J(r,G(t).name)},[()=>g(G(t))]),q(e,n)}),O(w),O(De);var T=R(De,2),E=R(I(T),2);Y(E,21,()=>G(n),Ir,(e,t)=>{var n=Fa(),r=I(n,!0);O(n),z(e=>{X(n,e),J(r,G(t).name)},[()=>h(G(t))]),q(e,n)}),O(E),O(T);var D=R(T,4);Y(D,20,()=>({length:10}),Ir,(e,t,n)=>{let i=xt(()=>f(G(r).v,G(p)?9-n:n,G(r).saturation,d));var a=Ia(),o=L(a),c=R(o,2);c.__click=()=>s(G(i)),z(()=>{Z(o,`for`,G(i)),X(o,`grid-area: c${n}; background-color: ${G(i)??``}`),Z(c,`id`,G(i))}),q(e,a)}),O(D);var Oe=R(D,4);Y(Oe,20,()=>({length:10}),Ir,(e,t,n)=>{let r=xt(()=>f(G(i).v,G(p)?n:9-n,G(i).saturation,d));var a=La(),o=L(a),c=R(o,2);c.__click=()=>s(G(r)),z(()=>{Z(o,`for`,G(r)),X(o,`grid-area: c${n}; background-color: ${G(r)??``}`),Z(c,`id`,G(r))}),q(e,a)}),O(Oe),O(Te),O(y);var Ae=R(y,2);Ae.__click=()=>la(`/modules`);var je=I(Ae);xa(I(je),{size:`30`}),O(je),O(Ae),z((e,t)=>{J(ce,`Base - ${G(r).v??``}`),X(le,`accent-color: hsl(${G(r).v??``}, 100%, 50%);`),J(de,`${G(r).saturation??``}% saturation`),X(fe,`accent-color: ${e??``}`),J(ge,`Base - ${G(i).v??``}`),X(_e,`accent-color: hsl(${G(i).v??``}, 100%, 50%);`),J(ye,`${G(i).saturation??``}% saturation`),X(be,`accent-color: ${t??``}`)},[()=>f(G(r).v,50,G(r).saturation,d),()=>f(G(i).v,50,G(i).saturation,d)]),Ni(le,()=>G(r).v,e=>G(r).v=e),Ni(fe,()=>G(r).saturation,e=>G(r).saturation=e),Ni(_e,()=>G(i).v,e=>G(i).v=e),Ni(be,()=>G(i).saturation,e=>G(i).saturation=e),q(e,v),j()}vr([`click`]);var Ba=K(`<p class="svelte-ockje"> </p>`),Va=K(`<div class="line svelte-ockje"></div>`),Ha=K(`<div class="barWrapper svelte-ockje"><div class="bar svelte-ockje"><div><p class="title svelte-ockje"> </p> <p class="svelte-ockje"> </p></div></div></div>`),Ua=K(`<p class="svelte-ockje"> </p>`),Wa=K(`<div class="barMain svelte-ockje"><div class="sideLabel svelte-ockje"><div class="spacer" style="height: 4px"></div> <!></div> <div class="barContainer svelte-ockje"><div class="bars svelte-ockje"><div class="lines svelte-ockje"><!> <div class="line svelte-ockje" style="opacity: 0.0;"></div></div> <!></div> <div class="labels svelte-ockje"></div></div></div>`);function Ga(e,t){A(t,!0);let n=e=>{let t=0;for(let n of e)n.value>t&&(t=n.value);return Math.ceil(t)},r=e=>{let t=0;for(;e>=1e3;)e/=1e3,t++;return`${e}${[``,`K`,`M`,`B`,`T`,`Q`,`Qu`,`Sx`,`Sp`,`Oc`,`No`][t]}`},i=e=>{let t=0;for(;e>=10;)e/=10,t++;e*=10;let n=e%10;return n-=n%2,n+=2,e=Math.floor(e/10),e*=10**t,e+=n*10**(t-1),e/4},a=xt(()=>n(t.points)),o=xt(()=>i(G(a)));var s=Wa(),c=I(s);Y(R(I(c),2),16,()=>({length:4}),Ir,(e,t,n)=>{var i=Ba(),a=I(i,!0);O(i),z(e=>J(a,e),[()=>r(Math.round(G(o)*(n+1)))]),q(e,i)}),O(c);var l=R(c,2),u=I(l),d=I(u);Y(I(d),16,()=>({length:4}),Ir,(e,t)=>{q(e,Va())}),ke(2),O(d),Y(R(d,2),17,()=>t.points,Ir,(e,n,r)=>{var i=Ha(),a=I(i),s=I(a),c=I(s),l=I(c,!0);O(c);var u=R(c,2),d=I(u,!0);O(u),O(s),O(a),O(i),z(()=>{X(a,`height: calc(${G(n).value/(G(o)*4)*100}%);`),pi(s,1,`barHidden ${r>t.points.length/2?`toLeft`:`toRight`}`,`svelte-ockje`),J(l,G(n).name),J(d,G(n).value)}),q(e,i)}),O(u);var f=R(u,2);Y(f,21,()=>t.points,Ir,(e,t)=>{var n=Ua(),r=I(n,!0);O(n),z(()=>J(r,G(t).name)),q(e,n)}),O(f),O(l),O(s),q(e,s),j()}function Ka(e){let t=e-1;return t*t*t+1}function qa(e){return e<.5?4*e*e*e:.5*(2*e-2)**3+1}function Ja(e){let t=typeof e==`string`&&e.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return t?[parseFloat(t[1]),t[2]||`px`]:[e,`px`]}function Ya(e,{delay:t=0,duration:n=400,easing:r=Ka,x:i=0,y:a=0,opacity:o=0}={}){let s=getComputedStyle(e),c=+s.opacity,l=s.transform===`none`?``:s.transform,u=c*(1-o),[d,f]=Ja(i),[p,m]=Ja(a);return{delay:t,duration:n,easing:r,css:(e,t)=>`
