...
/* Generated CSS */
`;for(let t of G(n))e+=h(t);await navigator.clipboard.writeText(e),alert(`CSS Copied`)},s=async e=>{await navigator.clipboard.writeText(e),alert(`CSS Copied`)},c=async()=>{let e=a();await navigator.clipboard.writeText(e),alert(`CSS Copied`)},l=(e,t)=>Math.round((t*10/(e*t/100-t)+t)*100)/100,u=(e,t=75)=>{e/=100;let n=(1-e)**3*100,r=3*e*(1-e)**2*t,i=3*e**2*(1-e)*t,a=e**3*0;return Math.round((n+r+i+a)*100)/100},d=[5,12,20,30,40,50,60,70,80,88],f=[0,6,10,15,40,60,85,90,93,99],p=(e,t,n=100,r=d,i=u)=>`hsl(${e}, ${i(r[t],n)}%, ${r[t]}%);`,m=P(!1),h=e=>{let t=``;return t+=`.${e.name} {
...
}`,t},g=e=>`background-color: ${p(e.v,3,e.saturation)} border: 1px solid ${p(e.v,4,e.saturation)}`,_=e=>`background-color: ${p(e.v,2,e.saturation)} color: ${p(e.v,7,e.saturation)} border: 1px solid ${p(e.v,5,e.saturation)}`,v=()=>{G(n).length=0;let e=$(180)+135,t=e-$(45)-20,a=$(55)+25,o=($(30)+350)%360,s=$(60)+40;F(n,[{name:`main`,v:e,saturation:s,id:Aa()},{name:`secondary`,v:t,saturation:s,id:Aa()},{name:`warn`,v:a,saturation:s,id:Aa()},{name:`fail`,v:o,saturation:s,id:Aa()}],!0);let c=$(20)+1;F(r,{v:e,saturation:c,id:Aa()},!0),F(i,{v:e,saturation:c,id:Aa()},!0)};var y=Ra(),b=L(y),x=I(b),ee=I(x),te=I(ee);ba(I(te),{size:`30`}),O(te),ke(2),O(ee);var ne=R(ee,4);Y(ne,17,()=>G(n),Ir,(e,t,n)=>{var r=ja(),i=I(r),a=I(i);Ei(a);var o=R(a,2),s=I(o);O(o);var c=R(o,2);Ei(c);var l=R(c,2),u=I(l);O(l);var d=R(l,2);Ei(d),O(i),O(r),z(e=>{J(s,`${G(t).v??``}deg`),X(c,`accent-color: hsl(${G(t).v??``}, 100%, 50%);`),J(u,`${G(t).saturation??``}% saturation`),X(d,`accent-color: ${e??``}`)},[()=>p(G(t).v,50,G(t).saturation)]),Ni(a,()=>G(t).name,e=>G(t).name=e),Ni(c,()=>G(t).v,e=>G(t).v=e),Ni(d,()=>G(t).saturation,e=>G(t).saturation=e),q(e,r)});var re=R(ne,2);re.__click=()=>G(n).push({name:`new_color`,v:0,saturation:100,id:Aa()}),wa(I(re),{size:`20`}),ke(),O(re);var ie=R(re,4),ae=I(ie),oe=R(I(ae),2);Da(I(oe),{get value(){return G(m)},set value(e){F(m,e,!0)}}),O(oe),O(ae),O(ie);var S=R(ie,2),se=I(S),ce=I(se),le=I(ce);O(ce);var ue=R(ce,2);Ei(ue);var de=R(ue,2),fe=I(de);O(de);var pe=R(de,2);Ei(pe),O(se),O(S);var me=R(S,4),he=I(me),ge=I(he),_e=I(ge);O(ge);var ve=R(ge,2);Ei(ve);var ye=R(ve,2),be=I(ye);O(ye);var xe=R(ye,2);Ei(xe),O(he),O(me);var Se=R(me,2);Se.__click=c;var Ce=I(Se);Ca(I(Ce),{size:`20`}),O(Ce),ke(),O(Se);var we=R(Se,2);we.__click=o;var C=I(we);ga(I(C),{size:`20`}),O(C),ke(),O(we);var Te=R(we,2);Te.__click=v,Ta(I(Te),{size:`20`}),ke(),O(Te),O(x);var Ee=R(x,2),De=R(I(Ee),2);Y(De,17,()=>G(n),Ir,(e,t)=>{var n=Na();Y(n,20,()=>({length:10}),Ir,(e,n,r)=>{var i=Ma(),a=L(i),o=R(a,2);o.__click=()=>s(p(G(t).v,r,G(t).saturation)),z((e,t,n)=>{Z(a,`for`,e),X(a,`grid-area: c${r}; background-color: ${t??``};`),Z(o,`id`,n)},[()=>p(G(t).v,r,G(t).saturation),()=>p(G(t).v,r,G(t).saturation),()=>p(G(t).v,r,G(t).saturation)]),q(e,i)}),O(n),q(e,n)});var w=R(De,2),T=R(I(w),2);Y(T,21,()=>G(n),Ir,(e,t)=>{var n=Pa(),r=I(n,!0);O(n),z(e=>{X(n,e),J(r,G(t).name)},[()=>_(G(t))]),q(e,n)}),O(T),O(w);var E=R(w,2),D=R(I(E),2);Y(D,21,()=>G(n),Ir,(e,t)=>{var n=Fa(),r=I(n,!0);O(n),z(e=>{X(n,e),J(r,G(t).name)},[()=>g(G(t))]),q(e,n)}),O(D),O(E);var Oe=R(E,4);Y(Oe,20,()=>({length:10}),Ir,(e,t,n)=>{let i=xt(()=>p(G(r).v,G(m)?9-n:n,G(r).saturation,f,l));var a=Ia(),o=L(a),c=R(o,2);c.__click=()=>s(G(i)),z(()=>{Z(o,`for`,G(i)),X(o,`grid-area: c${n}; background-color: ${G(i)??``}`),Z(c,`id`,G(i))}),q(e,a)}),O(Oe);var Ae=R(Oe,4);Y(Ae,20,()=>({length:10}),Ir,(e,t,n)=>{let r=xt(()=>p(G(i).v,G(m)?n:9-n,G(i).saturation,f,l));var a=La(),o=L(a),c=R(o,2);c.__click=()=>s(G(r)),z(()=>{Z(o,`for`,G(r)),X(o,`grid-area: c${n}; background-color: ${G(r)??``}`),Z(c,`id`,G(r))}),q(e,a)}),O(Ae),O(Ee),O(b);var je=R(b,2);je.__click=()=>la(`/modules`);var Me=I(je);xa(I(Me),{size:`30`}),O(Me),O(je),z((e,t)=>{J(le,`Base - ${G(r).v??``}`),X(ue,`accent-color: hsl(${G(r).v??``}, 100%, 50%);`),J(fe,`${G(r).saturation??``}% saturation`),X(pe,`accent-color: ${e??``}`),J(_e,`Base - ${G(i).v??``}`),X(ve,`accent-color: hsl(${G(i).v??``}, 100%, 50%);`),J(be,`${G(i).saturation??``}% saturation`),X(xe,`accent-color: ${t??``}`)},[()=>p(G(r).v,50,G(r).saturation,f),()=>p(G(i).v,50,G(i).saturation,f)]),Ni(ue,()=>G(r).v,e=>G(r).v=e),Ni(pe,()=>G(r).saturation,e=>G(r).saturation=e),Ni(ve,()=>G(i).v,e=>G(i).v=e),Ni(xe,()=>G(i).saturation,e=>G(i).saturation=e),q(e,y),j()}vr([`click`]);var Ba=K(`<p class="svelte-ockje"> </p>`),Va=K(`<div class="line svelte-ockje"></div>`),Ha=K(`<div class="barWrapper svelte-ockje"><div class="bar svelte-ockje"><div><p class="title svelte-ockje"> </p> <p class="svelte-ockje"> </p></div></div></div>`),Ua=K(`<p class="svelte-ockje"> </p>`),Wa=K(`<div class="barMain svelte-ockje"><div class="sideLabel svelte-ockje"><div class="spacer" style="height: 4px"></div> <!></div> <div class="barContainer svelte-ockje"><div class="bars svelte-ockje"><div class="lines svelte-ockje"><!> <div class="line svelte-ockje" style="opacity: 0.0;"></div></div> <!></div> <div class="labels svelte-ockje"></div></div></div>`);function Ga(e,t){A(t,!0);let n=e=>{let t=0;for(let n of e)n.value>t&&(t=n.value);return Math.ceil(t)},r=e=>{let t=0;for(;e>=1e3;)e/=1e3,t++;return`${e}${[``,`K`,`M`,`B`,`T`,`Q`,`Qu`,`Sx`,`Sp`,`Oc`,`No`][t]}`},i=e=>{let t=0;for(;e>=10;)e/=10,t++;e*=10;let n=e%10;return n-=n%2,n+=2,e=Math.floor(e/10),e*=10**t,e+=n*10**(t-1),e/4},a=xt(()=>n(t.points)),o=xt(()=>i(G(a)));var s=Wa(),c=I(s);Y(R(I(c),2),16,()=>({length:4}),Ir,(e,t,n)=>{var i=Ba(),a=I(i,!0);O(i),z(e=>J(a,e),[()=>r(Math.round(G(o)*(n+1)))]),q(e,i)}),O(c);var l=R(c,2),u=I(l),d=I(u);Y(I(d),16,()=>({length:4}),Ir,(e,t)=>{q(e,Va())}),ke(2),O(d),Y(R(d,2),17,()=>t.points,Ir,(e,n,r)=>{var i=Ha(),a=I(i),s=I(a),c=I(s),l=I(c,!0);O(c);var u=R(c,2),d=I(u,!0);O(u),O(s),O(a),O(i),z(()=>{X(a,`height: calc(${G(n).value/(G(o)*4)*100}%);`),pi(s,1,`barHidden ${r>t.points.length/2?`toLeft`:`toRight`}`,`svelte-ockje`),J(l,G(n).name),J(d,G(n).value)}),q(e,i)}),O(u);var f=R(u,2);Y(f,21,()=>t.points,Ir,(e,t)=>{var n=Ua(),r=I(n,!0);O(n),z(()=>J(r,G(t).name)),q(e,n)}),O(f),O(l),O(s),q(e,s),j()}function Ka(e){let t=e-1;return t*t*t+1}function qa(e){return e<.5?4*e*e*e:.5*(2*e-2)**3+1}function Ja(e){let t=typeof e==`string`&&e.match(/^\s*(-?[\d.]+)([^\s]*)\s*$/);return t?[parseFloat(t[1]),t[2]||`px`]:[e,`px`]}function Ya(e,{delay:t=0,duration:n=400,easing:r=Ka,x:i=0,y:a=0,opacity:o=0}={}){let s=getComputedStyle(e),c=+s.opacity,l=s.transform===`none`?``:s.transform,u=c*(1-o),[d,f]=Ja(i),[p,m]=Ja(a);return{delay:t,duration:n,easing:r,css:(e,t)=>`
			transform: ${l} translate(${(1-e)*d}${f}, ${(1-e)*p}${m});
			opacity: ${c-u*t}`}}function Xa(e,{delay:t=0,speed:n,duration:r,easing:i=qa}={}){let a=e.getTotalLength(),o=getComputedStyle(e);return o.strokeLinecap!==`butt`&&(a+=parseInt(o.strokeWidth)),r===void 0?r=n===void 0?800:a/n:typeof r==`function`&&(r=r(a)),{delay:t,duration:r,easing:i,css:(e,t)=>`
			stroke-dasharray: ${a};
			stroke-dashoffset: ${t*a};
		`}}var Za=K(`<div class="choice svelte-1iameg8"><div><p class="svelte-1iameg8"> </p></div></div>`),Qa=K(`<div class="dropdownContent svelte-1iameg8"></div>`),$a=K(`<div class="dropDown svelte-1iameg8"><!> <p class="svelte-1iameg8"> </p> <!> <!></div>`);function eo(e,t){A(t,!0);let n=P(!1),r=Q(t,`selected`,15),i=Q(t,`displayFunc`,3,e=>e),a=Q(t,`action`,3,e=>{}),o=e=>{F(n,!0),r(e),a()(e)};var s=$a();s.__click=()=>{F(n,!G(n))};var c=I(s),l=e=>{_a(e,{size:`16`})};Fr(c,e=>{t.stickLeft&&e(l)});var u=R(c,2),d=I(u,!0);O(u);var f=R(u,2),p=e=>{_a(e,{size:`16`})};Fr(f,e=>{t.stickLeft||e(p)});var m=R(f,2),h=e=>{var n=Qa();Y(n,21,()=>t.options,Ir,(e,t)=>{var n=Za();n.__click=()=>o(G(t));var a=I(n),s=I(a),c=I(s,!0);O(s),O(a),O(n),z(e=>{pi(a,1,`option ${r()==G(t)?`selected`:``}`,`svelte-1iameg8`),J(c,e)},[()=>i()(G(t))]),q(e,n)}),O(n),z(()=>X(n,`${t.stickLeft?`left`:`right`}: 0px;`)),ti(3,n,()=>Ya,()=>({x:50,duration:250})),q(e,n)};Fr(m,e=>{G(n)&&e(h)}),O(s),z(e=>J(d,e),[()=>i()(r())]),q(e,s),j()}vr([`click`]);var to=K(`<div class="box svelte-5gktaz"></div> <p class="display svelte-5gktaz"> </p>`,1),no=K(`<div class="pieChart svelte-5gktaz"><div class="container svelte-5gktaz"></div></div>`);function ro(e,t){A(t,!0),Q(t,`displayFunc`,3,e=>e);let n=e=>e/180*Math.PI,r=e=>{let t=Math.sin(-n(e)+n(90));return{x:Math.cos(-n(e)+n(90))*50+50,y:100-(t*50+50),quad:Math.floor((e-1e-6)/90)}},i=e=>{let t=r(360*e),n=`50% 50%, 50% 0%`,i=!1;if(t.quad==0){for(let e=0;e<4;e++)n+=`, ${t.x}% 0`;i=!0}else n+=`, 100% 0`;if(t.quad>=1)if(t.quad==1){for(let e=0;e<3;e++)n+=`, 100% ${t.y}%`;i=!0}else n+=`, 100% 100%`;if(t.quad>=2)if(t.quad==2&&!i){for(let e=0;e<2;e++)n+=`, ${t.x}% 100%`;i=!0}else n+=`, 0 100%`;return t.quad>=3&&(t.quad==3&&!i?(n+=`, 0 ${t.y}%`,i=!0):n+=`, 0 0`),n+=`, ${t.x}% ${t.y}%`,`clip-path: polygon(${n});`},a=(e,t)=>{let n=o(e),r=i(e[t].value/n),a=0;for(let r=0;r<t;r++){let t=e[r].value/n;a+=360*t}return`${r} background-color: var(--main${t+1}); rotate: ${a}deg;`},o=e=>{let t=0;for(let n of e)t+=n.value;return t};var s=no(),c=I(s);Y(c,21,()=>t.points,Ir,(e,n,r)=>{var i=to(),o=L(i),s=R(o,2),c=I(s,!0);O(s),z(e=>{X(o,e),J(c,G(n).name)},[()=>a(t.points,r)]),q(e,i)}),O(c),O(s),q(e,s),j()}var io=Er(`<path></path>`),ao=K(`<div class="mainLines svelte-1g4kjfq"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="svelte-1g4kjfq"></svg></div>`);function oo(e,t){A(t,!0);let n=P(!1);$i(()=>{F(n,!0)});let r=(e,t)=>{let n=$(4e3)+500,r=$(3)+1,i=$(4),a=$(e),o=a+($(100)-50),s=!1;$(1)==1&&(s=!0);let c=$(4)+1;return{size:r,path:`M${a}, -10 C${e/2+$(e/c)/r*(s?-1:1)}, ${t/2+$(t/c)/r} ${e/2+$(e/c)/r*(s?1:-1)}, ${t/2+$(t/c)/r-50} ${o}, ${t}`,time:n,id:Aa(),color:i}},i=Rt([]),a=P(0),o=P(0);$i(()=>{new ResizeObserver(e=>{for(let t of e)F(a,t.contentRect.width,!0),F(o,t.contentRect.height,!0)}).observe(G(s))});let s=P(null);setInterval(()=>{i.length>10&&i.splice(0,1),i.push(r(G(a),G(o)))},1e3);var c=ao(),l=I(c);Y(l,23,()=>i,e=>e.id,(e,n)=>{var r=io();z(()=>{Z(r,`d`,G(n).path),Z(r,`stroke-width`,9/G(n).size),X(r,`z-index: ${3-G(n).size}; color: var(--${t.colors[G(n).color]??``});`)}),ti(3,r,()=>Xa,()=>({duration:G(n).time})),q(e,r)}),O(l),O(c),Li(c,e=>F(s,e),()=>G(s)),z(()=>{Z(l,`viewBox`,`0 0 ${G(a)??``} ${G(o)??``}`),Z(l,`width`,G(a)),Z(l,`height`,G(o))}),q(e,c),j()}var so=K(`<div class="wrapper svelte-ywc6gn" role="textbox" tabindex="0"><div contenteditable="true" role="textbox" class="p svelte-ywc6gn"></div></div>`);function co(e,t){A(t,!0);let n=Q(t,`value`,15),r=Q(t,`placeholder`,3,`Placeholder...`),i=Q(t,`style`,3,``),a=Q(t,`fontSize`,3,20),o=Q(t,`padding`,3,20),s=e=>{e.key==`Backspace`&&setTimeout(()=>{n().length==1&&n()==`
`&&n(``)})},c;function l(){c.focus()}var u=so();u.__click=()=>l();var d=I(u);d.__keydown=s,Li(d,e=>c=e,()=>c),O(u),z(()=>{X(u,i()),X(d,`font-size: calc(${a()??``}px + var(--font-size-modifier)); padding: ${o()??``}px;`),Z(d,`data-placeholder`,r())}),Ri(`innerText`,d,n),q(e,u),j()}vr([`click`,`keydown`]);var lo=Er(`<path></path>`),uo=K(`<div class="mainLines svelte-1fdnbs3"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="svelte-1fdnbs3"></svg></div>`);function fo(e,t){A(t,!0);let n=P(!1);$i(()=>{F(n,!0)});let r=(e,n)=>{let r=$(t.speed)+500,i=$(3)+1,a=$(4),o=$(2)==0,s=$(o?e:n);return{size:i,path:`M ${o?s:-10}, ${o?-10:s} L${o?n+s:n-s}, ${n+10}`,time:r,id:Aa(),color:a}},i=Rt([]),a=P(0),o=P(0);$i(()=>{new ResizeObserver(e=>{for(let t of e)F(a,t.contentRect.width,!0),F(o,t.contentRect.height,!0)}).observe(G(s))});let s=P(null);setInterval(()=>{i.length>t.number&&i.splice(0,1),i.push(r(G(a),G(o)))},1e3);var c=uo(),l=I(c);Y(l,23,()=>i,e=>e.id,(e,n)=>{var r=lo();z(()=>{Z(r,`d`,G(n).path),Z(r,`stroke-width`,9/G(n).size),X(r,`z-index: ${3-G(n).size}; color: var(--${t.colors[G(n).color]??``});`)}),ti(3,r,()=>Xa,()=>({duration:G(n).time})),q(e,r)}),O(l),O(c),Li(c,e=>F(s,e),()=>G(s)),z(()=>{Z(l,`viewBox`,`0 0 ${G(a)??``} ${G(o)??``}`),Z(l,`width`,G(a)),Z(l,`height`,G(o))}),q(e,c),j()}var po=Er(`<path></path>`),mo=K(`<div class="mainLines svelte-po6ebd"><svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" class="svelte-po6ebd"></svg></div>`);function ho(e,t){A(t,!0);let n=P(!1);$i(()=>{F(n,!0)});let r=(e,n)=>{let r=$(t.speed)+500,i=$(3)+1,a=$(4),o=$(e),s=$(n),c=$(4)+1,l=`M ${o}, ${s} `;for(let t=0;t<c;t++){let t=$(e),r=$(e),i=$(n),a=$(n);l+=`S${t}, ${i} ${r}, ${a} `}return{size:i,path:l,time:r,id:Aa(),color:a}},i=Rt([]),a=P(0),o=P(0);$i(()=>{new ResizeObserver(e=>{for(let t of e)F(a,t.contentRect.width,!0),F(o,t.contentRect.height,!0)}).observe(G(s))});let s=P(null);setInterval(()=>{i.length>t.number&&i.splice(0,1),i.push(r(G(a),G(o)))},1e3);var c=mo(),l=I(c);Y(l,23,()=>i,e=>e.id,(e,n)=>{var r=po();z(()=>{Z(r,`d`,G(n).path),Z(r,`stroke-width`,9/G(n).size),X(r,`z-index: ${3-G(n).size}; color: var(--${t.colors[G(n).color]??``});`)}),ti(3,r,()=>Xa,()=>({duration:G(n).time})),q(e,r)}),O(l),O(c),Li(c,e=>F(s,e),()=>G(s)),z(()=>{Z(l,`viewBox`,`0 0 ${G(a)??``} ${G(o)??``}`),Z(l,`width`,G(a)),Z(l,`height`,G(o))}),q(e,c),j()}var go=K(`<div class="uiMain"><div class="gridBox svelte-1ub297s"><div class="card bb2 svelte-1ub297s" style="grid-area: box-1;"><div class="title svelte-1ub297s"><p>Global Code</p></div> <p>Create a file called global.svelte.js, copy and paste!</p> <button class="btn main"><!> Copy Code</button></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-2;"><div class="title svelte-1ub297s"><p>DropDown</p></div> <p>Right Dropdown</p> <!> <p>Left Dropdown</p> <!> <p>Actioned Dropdown</p> <!> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-3;"><div class="title svelte-1ub297s"><p>Bar Graph</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-4;"><div class="title svelte-1ub297s"><p>Splash</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-5;"><div class="title svelte-1ub297s"><p>Pie Chart</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-6;"><div class="title svelte-1ub297s"><p>Text Area</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-7;"><div class="title svelte-1ub297s"><p>Wind</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-8;"><div class="title svelte-1ub297s"><p>Squiggles</p></div> <div class="wrapper svelte-1ub297s"><!></div> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-9;"><div class="title svelte-1ub297s"><p>Toggle</p></div> <p>Simple Toggle</p> <!> <p>Actioned Toggle</p> <!> <div class="buttons svelte-1ub297s"><button class="svelte-1ub297s"><!></button></div></div> <div class="card bb2 svelte-1ub297s" style="grid-area: box-a;"><div class="title svelte-1ub297s"><p>Custom Draw</p></div> <p>Create a folder called utils next to your modules, and create customDraw.js. Put this in there. Edit placeholder anim code, and set in to be draw, and out to be customDraw.</p> <button class="btn main"><!> Copy Code</button></div></div></div> <button class="moveButton bb3"><div class="svgWrapper"><!></div></button>`,1);function _o(e,t){A(t,!0);let n=P(!1),r=P(!1),i=P(`Option 1`),a=P(`Option 2`),o=P(`Option 3`),s=P(Rt([{name:`Item 1`,value:100},{name:`Item 2`,value:71},{name:`Item 3`,value:26}])),c=P(``),l=async e=>{await navigator.clipboard.writeText(e),alert(`Code Copied`)},u=[`main5`,`main6`,`main7`,`text1`];var d=go(),f=L(d),p=I(f),m=I(p),h=R(I(m),4);h.__click=()=>l(`
...
export const getID = () => {
    ...
    return id;
}`),ya(I(h),{size:`20`}),ke(),O(h),O(m);var g=R(m,2),_=R(I(g),4);eo(_,{options:[`Option 1`,`Option 2`,`Option 3`],stickLeft:!1,get selected(){return G(i)},set selected(e){F(i,e,!0)}});var v=R(_,4);eo(v,{options:[`Option 1`,`Option 2`,`Option 3`],stickLeft:!0,get selected(){return G(a)},set selected(e){F(a,e,!0)}});var y=R(v,4);eo(y,{options:[`Option 1`,`Option 2`,`Option 3`],stickLeft:!1,action:e=>{alert(`You selected `+e)},get selected(){return G(o)},set selected(e){F(o,e,!0)}});var b=R(y,2),x=I(b);x.__click=()=>l(`<script>
...
</style>`),ya(I(x),{size:`20`}),O(x),O(b),O(g);var ee=R(g,2),te=R(I(ee),2);Ga(I(te),{get points(){return G(s)},set points(e){F(s,e,!0)}}),O(te);var ne=R(te,2),re=I(ne);re.__click=()=>l(`<script>
...
</style>`),ya(I(re),{size:`20`}),O(re),O(ne),O(ee);var ie=R(ee,2),ae=R(I(ie),2);oo(I(ae),{get colors(){return u}}),O(ae);var oe=R(ae,2),S=I(oe);S.__click=()=>l(`<script>
...
</style>`),ya(I(S),{size:`20`}),O(S),O(oe),O(ie);var se=R(ie,2),ce=R(I(se),2);ro(I(ce),{get points(){return G(s)},set points(e){F(s,e,!0)}}),O(ce);var le=R(ce,2),ue=I(le);ue.__click=()=>l(`
<script>
...
</style>`),ya(I(ue),{size:`20`}),O(ue),O(le),O(se);var de=R(se,2),fe=R(I(de),2);co(I(fe),{get value(){return G(c)},set value(e){F(c,e,!0)}}),O(fe);var pe=R(fe,2),me=I(pe);me.__click=()=>l(`<script>
...
</style>`),ya(I(me),{size:`20`}),O(me),O(pe),O(de);var he=R(de,2),ge=R(I(he),2);fo(I(ge),{get colors(){return u},number:20,speed:2e3}),O(ge);var _e=R(ge,2),ve=I(_e);ve.__click=()=>l(`
<script>
    import { onMount } from "svelte";
    import { draw } from "svelte/transition";
    import { getRandomInt, getID } from "../../global.svelte";
...
</style>`),ya(I(ve),{size:`20`}),O(ve),O(_e),O(he);var ye=R(he,2),be=R(I(ye),2);ho(I(be),{get colors(){return u},number:10,speed:5e3}),O(be);var xe=R(be,2),Se=I(xe);Se.__click=()=>l(`<script>
    import { onMount } from "svelte";
    import { draw } from "svelte/transition";
    import { getRandomInt, getID } from "../../global.svelte";
    let show = $state(false);
...
</style>`),ya(I(Se),{size:`20`}),O(Se),O(xe),O(ye);var Ce=R(ye,2),we=R(I(Ce),4);Da(we,{get value(){return G(n)},set value(e){F(n,e,!0)}});var C=R(we,4);Da(C,{action:()=>{alert(`This toggle has an action!`)},get value(){return G(r)},set value(e){F(r,e,!0)}});var Te=R(C,2),Ee=I(Te);Ee.__click=()=>l(`<script>
